...
GCC_PATH="/home/vinc/Programs/gcc-arm-none-eabi-10.3-2021.10/bin/
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"/home/vinc/Programs/xpack-openocd-0.11.0-4/bin/openocd" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"/home/vinc/Programs/xpack-openocd-0.11.0-4/bin/openocd" -f ./openocd.cfg -c "init; reset halt; stm32f0x mass_erase 0; exit"
